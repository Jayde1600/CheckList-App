...
import com.example.checklist_app.Adapter.ToDoAdapter;

import it.xabaras.android.recyclerview.swipedecorator.RecyclerViewSwipeDecorator;

public class InteractHelper extends ItemTouchHelper.SimpleCallback {

    private ToDoAdapter adapter;

    public InteractHelper(ToDoAdapter adapter) {
